...
import { Reto04ProductService } from './ejercicios/reto-04-product-service/reto-04-product-service';

@Component({
  selector: 'app-root',
  imports: [Reto01CounterService, Reto02ThemeService, Reto03NotificationService, Reto04ProductService],
